<script lang="ts">
	import { loadingPercent, loadedObjects, objectsToLoad, showAdditionalLoader } from '../store';
...
<div transition:fly={{ x: 200, easing: sineInOut, duration: 1_250 }} class="container">
	<header>
		<svg
			fill="none"
			stroke="currentColor"
